...
| **Extensions** | IDE extensions installable via the plugin marketplace (v1.0.62+); canvas extensions can also be bundled under a `com.github.copilot/extensions/` directory in the plugin (v1.0.79+) | `extensions/` |
