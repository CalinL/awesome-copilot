...
If you're already working in a Copilot CLI session and want to continue in the GitHub Copilot app's richer interface, use the `/app` command (v1.0.79+):

```
/app
```

This opens the current CLI session directly in the Copilot desktop app, preserving your context and work. Requires GitHub Copilot app version 1.1.3 or later.
