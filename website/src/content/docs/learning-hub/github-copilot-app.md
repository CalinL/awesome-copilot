...
If you are already in a terminal session, use the `copilot app` command *(v1.0.79+)* to open the GitHub Copilot app in the current directory without navigating through the app manually:
