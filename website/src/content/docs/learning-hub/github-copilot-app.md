...
*(v1.0.81+)* If you use the GitHub Copilot CLI, you can open the Copilot app in your current directory with a single command:

```bash
copilot app
```

This launches the Copilot app context for the repository you're currently working in, without needing to navigate to it through the app UI.
