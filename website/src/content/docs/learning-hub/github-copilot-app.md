...
#### Opening the App from an Active CLI Session

*(v1.0.79+)* If you're already working in a Copilot CLI session, use the `/app` command to open that session directly in the GitHub Copilot desktop app:

```
/app
```

This switches you to a graphical view of your current session without losing context (requires GitHub Copilot app 1.1.3 or later).
